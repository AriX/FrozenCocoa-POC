...
CFTypeID __kCFStringTypeID = _kCFRuntimeNotATypeID;
...
CFComparisonResult CFStringCompareWithOptionsAndLocale(CFStringRef string, CFStringRef string2, CFRange rangeToCompare, CFOptionFlags compareOptions, CFLocaleRef locale) {
    // SUPER HACK
    return CFStringCompareWithOptions(string, string2, rangeToCompare, compareOptions);
}
...
{
    // SUPER HACK
    return CFStringFindWithOptions(string, stringToFind, rangeToSearch, compareOptions, result);
}
