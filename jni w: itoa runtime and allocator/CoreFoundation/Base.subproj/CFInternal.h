...
#define __CFBitfieldGetValue(V, N1, N2) \
    (((V) & __CFBitfieldMask(N1, N2)) >> (N2))
#define __CFBitfieldSetValue(V, N1, N2, X) \
    ((V) = ((V) & ~__CFBitfieldMask(N1, N2)) | (((X) << (N2)) & __CFBitfieldMask(N1, N2)))
#define __CFBitfieldMaxValue(N1, N2) \
    __CFBitfieldGetValue(0xFFFFFFFFUL, (N1), (N2))
#define __CFBitIsSet(V, N) \
    (((V) & (1UL << (N))) != 0)
#define __CFBitSet(V, N) \
    ((V) |= (1UL << (N)))
#define __CFBitClear(V, N) \
    ((V) &= ~(1UL << (N)))
